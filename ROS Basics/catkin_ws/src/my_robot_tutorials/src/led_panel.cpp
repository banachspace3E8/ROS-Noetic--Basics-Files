...
bool callback_set_led(my_robot_msgs::SetLed::Request &req,my_robot_msgs::SetLed::Response &res){
...
int main(int argc, char **argv){
	...
	ros::ServiceServer server = nh.advertiseService("/set_led",callback_set_led);
