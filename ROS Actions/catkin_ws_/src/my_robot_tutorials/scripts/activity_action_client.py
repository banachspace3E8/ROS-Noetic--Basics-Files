...
#Action client to send the goal to the server
...
class CountUntilClient:
    ...
    def __init__(self):
        ...
        rospy.loginfo("Action is up,we can send goals.")
        self._goal_handles ={}
    ...
    def on_transition(self, goal_handle):
        ...
        #comm state transition #s is not same as goal state transition numbers
...
if __name__ == '__main__':
    rospy.init_node('cout_until_client')
